...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Send__rosidl_typesupport_introspection_c__Send_message_member_array[7] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Send, cmd_vel),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auto_aim_interfaces, msg, Send)() {
  ...
  auto_aim_interfaces__msg__Send__rosidl_typesupport_introspection_c__Send_message_member_array[6].members_ =
